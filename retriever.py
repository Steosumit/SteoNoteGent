...
class custom_retriever():
    ...
    def __init__(self, file_path: str):
        ...
        self. retreiver = None  # retriever object
    ...
    def embed_storage(self):
        ...
        self.retreiver = vectorstore.as_retriever(
...
if __name__ == "__main__":
    retriever_instance = custom_retriever("sample_data.csv")
